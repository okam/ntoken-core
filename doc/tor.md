...
port 9050 and only allows .onion nodes to connect:
	...
	./ntokend -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion
...
your ntokend's P2P listen port (9999 by default).
...
3. List of known nToken Core Tor relays
------------------------------------
